                        ...
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white w-lg-45">
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-gronup">
                                        <div class="custom-control custom-control-xs custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="checkbox">I agree to  NexgetFXs <a tabindex="-1" href="https:// NexgetFXs.net/privacy.html">Privacy Policy</a> &amp; <a tabindex="-1" href="https:// NexgetFXs.net/terms.html"> Terms.</a></label>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                            ...
                            <div class="nk-block nk-auth-footer">
                                <div class="nk-block-between">
                                    <ul class="nav nav-sm">
                                        <li class="nav-item">
                                            <a class="nav-link" href="https:// NexgetFXs.net/terms.html">Terms & Condition</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="https:// NexgetFXs.net/privacy.html">Privacy Policy</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="https:// NexgetFXs.net/contact.html">Contact Us</a>
                                        </li>
                                ...
                                <div class="mt-3">
                                    <p>&copy; 2024  NexgetFXs. All Rights Reserved.</p>
                                </div>
                            </div><!-- nk-block -->
