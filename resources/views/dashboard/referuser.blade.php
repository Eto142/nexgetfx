          ...
          <div class="col">
           ...
           <!-- <div class="refer-form-content">
              ...
              <!--<form action="" method="post">-->
                ...
                <input type="text" id="refer" value="https:// NexgetFXs.net/src/auths/register.php?refer=94388539" disabled>
                <!--<input type="text" id="refer" value="https:// NexgetFX.com/src/auths/register.php?refer=94388539">-->
                <!--<p>-->
